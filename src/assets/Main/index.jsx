...
export default function FormItem() {
  return (
    <FormDiv>
      <>
        <HeadingH2>Kompaniya ma’lumotlari</HeadingH2>
        <HeadingP>Kompaniya haqidagi ma’lumotlarni kiriting</HeadingP>
      </>
      <Form>
        <ImgDiv>
        ...
        <Inp>
            <Input label="Kompaniya nomi" pls="Kompaniya nomi"></Input>
            <Input label="Email" pls="Email"></Input>
            <Input label="Telefon raqami" pls="UZ +9989"></Input>       
            <Links>
                <p>Linklar</p>
                <LinksUl>
                    <LinksUlLi>
            ...
            <Location>
                <Input label="Davlat" pls="Davlat"></Input>             
                <Input label="Shahar" pls="Shahar"></Input>             
            </Location>
            <Input label="Yashash joyi" pls="Joy"></Input>       
            <Input label="Hodimlar soni" pls="Hodimlar soni"></Input>  
            <Desc>
                <DescP>Izoh</DescP>
                <DescText placeholder='Kompaniya haqida izoh qoldiring'></DescText>
            </Desc>     
            <Buttons>
                <Cencel>Ortga</Cencel>
                <Next>Keyingisi</Next>
